...
seqfile  = podarcis-coding.phy     # sequence file (per-locus alignments)
Imapfile = podarcis.map     # assignments of samples to species
outfile  = out_coding_all.A00.txt    # output log file
mcmcfile = mcmc_coding_all.A00 txt   # file to log mcmc samples
...
species&tree = 11 Pvau Plus Pmur Psic Plev Ppel Pwag Pfil Ppit Ptil out
               ...
               ((((z[&phi=0.100000,tau-parent=no],(((Pvau,Plus)k)r[&phi=0.900000,tau-parent=yes],(p[&phi=0.200000,tau-parent=yes],Pmur)o)i)y,((t[&phi=0.400000,tau-parent=yes]>
...
# threads
threads = 98 2 1      # threads = threads starting_core step
