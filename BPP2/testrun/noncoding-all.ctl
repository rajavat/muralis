...
outfile  = out_noncoding_all.A00.txt    # output log file
mcmcfile = mcmc_noncoding_all.A00 txt   # file to log mcmc samples
...
# threads
threads = 92 2 1      # threads = threads starting_core step
